...
import { sendOutboundMarketplaceOfferForFederatedListing } from "@/lib/marketplace-outbound-offer-service";
...
export async function POST(request: Request, context: Params) {
  ...
  try {
    const offer = await sendOutboundMarketplaceOfferForFederatedListing(user.id, id, {
